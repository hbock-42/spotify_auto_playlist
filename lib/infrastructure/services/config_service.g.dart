...
_SpotifyConfig _$SpotifyConfigFromJson(Map<String, dynamic> json) => _SpotifyConfig(
  redirectUri: json['redirectUri'] as String,
  scopes: (json['scopes'] as List<dynamic>).map((e) => e as String).toList(),
);

Map<String, dynamic> _$SpotifyConfigToJson(_SpotifyConfig instance) => <String, dynamic>{
...
Map<String, dynamic> _$ApiConfigToJson(_ApiConfig instance) => <String, dynamic>{
  'baseUrl': instance.baseUrl,
  'tokenUrl': instance.tokenUrl,
  'authorizeUrl': instance.authorizeUrl,
};

_FeaturesConfig _$FeaturesConfigFromJson(Map<String, dynamic> json) => _FeaturesConfig(
...
Map<String, dynamic> _$FeaturesConfigToJson(_FeaturesConfig instance) => <String, dynamic>{
